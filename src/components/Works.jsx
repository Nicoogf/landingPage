...
function Works() {
  return (
    ...
    <div className='p-20'>
        <div className="mb-8">
            <h2 className='text-[40px] font-bold'>We create world-Class digital Products</h2>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            ...
            <img src={foto1}  className='w-full rounded-3xl'/>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex flex-col gap-4">
                        <img src={foto2} alt="" className='w-full rounded-3xl'/>
                        <p className='text-gray-500 '>App Desing -Agosto 15 , 2023</p>
                        <h3 className="text-xl font-bold">Redesign channel website landng page</h3>
                    </div>

                    <div className="flex flex-col gap-4">
                        <img src={foto3} alt="" className='w-full rounded-3xl'/>
                        <p className='text-gray-500 '>App Desing -Agosto 15 , 2023</p>
                        <h3 className="text-xl font-bold">Redesign channel website landng page</h3>
                    </div>

                    <div className="flex flex-col gap-4">
                        <img src={foto4} alt="" className='w-full rounded-3xl'/>
                        <p className='text-gray-500 '>App Desing -Agosto 15 , 2023</p>
                        <h3 className="text-xl font-bold">Redesign channel website landng page</h3>
                    </div>

                    <div className="flex flex-col gap-4">
                        <img src={foto5} alt="" className='w-full rounded-3xl'/>
                        <p className='text-gray-500 '>App Desing -Agosto 15 , 2023</p>
                        <h3 className="text-xl font-bold">Redesign channel website landng page</h3>
                    </div>
